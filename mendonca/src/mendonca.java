...
public class mendonca {
	...
	public static void main(String[] args) throws Exception {
		...
		double symmetric_features = mendonca.calcSymmetricFeatures(featureModel.getRoot(),featureModel);
		symmetric_features = symmetric_features + mendonca.calcSymmetricConstraints(featureModel);
